;;; acme-theme.el --- Plan 9 acme theme
...
;; Low distraction, minimalistic color theme that tries to emulate Acme.
;; Acme is a lot more than just the colour scheme. Here we only try to
;; emulate the color theme. We stive to use typograhic elements to highlight
...
(deftheme acme
  "Theme emulating Plan 9's Acme editor.")
...
(let ((fg "#111111")
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((t (:background ,bg-modeline :foreground ,fg :height 0.8))))
